...
All notable changes to `buffr-bookmarks` are documented here. Format follows
...
[Unreleased]:
  https://github.com/kryptic-sh/buffr-bookmarks/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/kryptic-sh/buffr-bookmarks/releases/tag/v0.1.2
[0.1.1]: https://github.com/kryptic-sh/buffr-bookmarks/releases/tag/v0.1.1
