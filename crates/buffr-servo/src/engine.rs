//! [`ServoEngine`] — stub [`BrowserEngine`] impl for the Servo backend.
...
impl BrowserEngine for ServoEngine {
    fn close_all_browsers(&self) {
        tracing::debug!("servo::close_all_browsers not yet implemented");
    }
    ...
    fn select_tab(&self, _id: TabId) {
        tracing::debug!("servo::select_tab not yet implemented");
    }

    fn next_tab(&self) {
        tracing::debug!("servo::next_tab not yet implemented");
    }

    fn prev_tab(&self) {
        tracing::debug!("servo::prev_tab not yet implemented");
    }

    fn move_tab(&self, _from: usize, _to: usize) {
        tracing::debug!("servo::move_tab not yet implemented");
    }
    ...
    fn toggle_pin_active(&self) {
        tracing::debug!("servo::toggle_pin_active not yet implemented");
    }

    fn set_pinned(&self, _id: TabId, _pinned: bool) {
        tracing::debug!("servo::set_pinned not yet implemented");
    }
    ...
    fn resize(&self, _width: u32, _height: u32) {
        tracing::debug!("servo::resize not yet implemented");
    }

    fn set_device_scale(&self, _scale: f32) {
        tracing::debug!("servo::set_device_scale not yet implemented");
    }

    fn set_frame_rate(&self, _hz: u32) {
        tracing::debug!("servo::set_frame_rate not yet implemented");
    }

    fn notify_screen_info_changed(&self) {
        tracing::debug!("servo::notify_screen_info_changed not yet implemented");
    }

    fn osr_resize(&self, _width: u32, _height: u32) {
        tracing::debug!("servo::osr_resize not yet implemented");
    }

    fn osr_key_event(&self, _event: NeutralKeyEvent) {
        tracing::debug!("servo::osr_key_event not yet implemented");
    }

    fn osr_mouse_move(&self, _x: i32, _y: i32, _modifiers: u32) {
        tracing::debug!("servo::osr_mouse_move not yet implemented");
    }
    ...
    fn osr_mouse_click(
        ...
        tracing::debug!("servo::osr_mouse_click not yet implemented");
    }

    fn osr_mouse_leave(&self, _modifiers: u32) {
        tracing::debug!("servo::osr_mouse_leave not yet implemented");
    }

    fn osr_mouse_wheel(&self, _x: i32, _y: i32, _delta_x: i32, _delta_y: i32, _modifiers: u32) {
        tracing::debug!("servo::osr_mouse_wheel not yet implemented");
    }

    fn osr_focus(&self, _focused: bool) {
        tracing::debug!("servo::osr_focus not yet implemented");
    }
    ...
    fn force_repaint_active(&self) {
        tracing::debug!("servo::force_repaint_active not yet implemented");
    }

    fn osr_sleep(&self, _sleep: bool) {
        tracing::debug!("servo::osr_sleep not yet implemented");
    }

    fn osr_invalidate_view(&self) {
        tracing::debug!("servo::osr_invalidate_view not yet implemented");
    }

    fn set_osr_wake(&self, _wake: Arc<dyn Fn() + Send + Sync>) {
        tracing::debug!("servo::set_osr_wake not yet implemented");
    }

    fn start_find(&self, _query: &str, _forward: bool) {
        tracing::debug!("servo::start_find not yet implemented");
    }

    fn stop_find(&self) {
        tracing::debug!("servo::stop_find not yet implemented");
    }
    ...
    fn popup_resize(&self, _browser_id: i32, _width: u32, _height: u32) {
        tracing::debug!("servo::popup_resize not yet implemented");
    }

    fn popup_close(&self, _browser_id: i32) {
        tracing::debug!("servo::popup_close not yet implemented");
    }
    ...
    fn popup_history_back(&self, _browser_id: i32) {
        tracing::debug!("servo::popup_history_back not yet implemented");
    }

    fn popup_history_forward(&self, _browser_id: i32) {
        tracing::debug!("servo::popup_history_forward not yet implemented");
    }

    fn popup_osr_focus(&self, _browser_id: i32, _focused: bool) {
        tracing::debug!("servo::popup_osr_focus not yet implemented");
    }

    fn popup_osr_key_event(&self, _browser_id: i32, _event: NeutralKeyEvent) {
        tracing::debug!("servo::popup_osr_key_event not yet implemented");
    }
    ...
    fn popup_osr_mouse_click(
        ...
        tracing::debug!("servo::popup_osr_mouse_click not yet implemented");
    }

    fn popup_osr_mouse_move(&self, _browser_id: i32, _x: i32, _y: i32, _modifiers: u32) {
        tracing::debug!("servo::popup_osr_mouse_move not yet implemented");
    }
    ...
    fn popup_osr_mouse_wheel(
        ...
        tracing::debug!("servo::popup_osr_mouse_wheel not yet implemented");
    }
    ...
    fn cancel_hint(&self) {
        tracing::debug!("servo::cancel_hint not yet implemented");
    }
}
