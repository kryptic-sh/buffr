...
All notable changes to `buffr-history` are documented here. Format follows
...
[Unreleased]: https://github.com/kryptic-sh/buffr-history/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/kryptic-sh/buffr-history/releases/tag/v0.1.2
[0.1.1]: https://github.com/kryptic-sh/buffr-history/releases/tag/v0.1.1
