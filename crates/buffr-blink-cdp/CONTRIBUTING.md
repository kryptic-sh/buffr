# Contributing to `buffr-blink-cdp`

Thanks for considering a contribution. `buffr-blink-cdp` is pre-1.0 and the
...
```bash
git clone git@github.com:kryptic-sh/buffr-blink-cdp.git
cd buffr-blink-cdp
