# Contributing to `buffr-engine`

Thanks for considering a contribution. `buffr-engine` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-engine.git
cd buffr-engine
