# Contributing to `buffr-history`

Thanks for considering a contribution. `buffr-history` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-history.git
cd buffr-history
