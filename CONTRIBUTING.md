# Contributing to `buffr-modal`

Thanks for considering a contribution. `buffr-modal` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-modal.git
cd buffr-modal
