# Contributing to `buffr-bookmarks`

Thanks for considering a contribution. `buffr-bookmarks` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-bookmarks.git
cd buffr-bookmarks
