# Contributing to `buffr-view-source`

Thanks for considering a contribution. `buffr-view-source` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-view-source.git
cd buffr-view-source
