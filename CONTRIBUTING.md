# Contributing to `buffr-zoom`

Thanks for considering a contribution. `buffr-zoom` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-zoom.git
cd buffr-zoom
