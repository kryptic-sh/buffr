# Contributing to `buffr-config`

Thanks for considering a contribution. `buffr-config` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-config.git
cd buffr-config
